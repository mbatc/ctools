...
template<typename T, typename T2> T& ctAssign(T &lhs, const T2 &rhs) { lhs = (T)rhs; return lhs; }
template<typename T, typename T2> T ctAssign(const T2 &rhs) { T lhs; return ctAssign<T, T2>(lhs, rhs); }
